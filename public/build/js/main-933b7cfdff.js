...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-d1cc177a", module.exports)
  } else {
    hotAPI.update("_v-d1cc177a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<validator name=\"todoAddForm\">\n    <form v-on:submit.prevent=\"addTodo()\" novalidate=\"\">\n      <div class=\"form-group\">\n        <input id=\"todotext\" type=\"text\" class=\"form-control\" placeholder=\"Add a new Todo\" v-validate:todotext=\"{required: { rule: true, message: 'Todo text is required.' }}\" v-model=\"todo.title\">\n            <span v-if=\"$todoAddForm.todotext.required &amp;&amp; $todoAddForm.todotext.touched === true\">\n                {{ $todoAddForm.todotext.required }}\n            </span>\n      </div>\n    </form>\n</validator>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-27d37340", module.exports)
  } else {
    hotAPI.update("_v-27d37340", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _TodoAdd = require('./TodoAdd.vue');
...
exports.default = {
    ...
    vuex: {
        ...
        actions: {
            getTodos: _todoActions.getTodos, deleteTodo: _todoActions.deleteTodo, toggleTodoStatus: _todoActions.toggleTodoStatus
        }
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<!-- <pre>{{ $data | json }}</pre> -->\n<!-- <pre>{{ todoStore | json }}</pre> -->\n<div>\n  <ul class=\"list-group\">\n    <li v-for=\"todo in todoStore\" class=\"list-group-item\" v-bind:class=\"{ 'completed' : todo.completed }\">\n        {{todo.title}}\n\n        <button class=\"btn btn-xs btn-danger pull-right\" v-on:click=\"todoDelete(todo)\">\n            <i class=\"fa fa-trash\"></i>\n        </button>\n        <button class=\"btn btn-xs pull-right margin-right-10\" v-bind:class=\"{'btn-success' : todo.completed, 'btn-warning' : !todo.completed}\" v-on:click=\"todoCompleted(todo)\">{{todo.completed ? 'Completed' : 'Pending'}}</button>\n      </li>\n  </ul>\n  <todo-add></todo-add>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-001c7f82", module.exports)
  } else {
    hotAPI.update("_v-001c7f82", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var toggleTodoStatus = exports.toggleTodoStatus = function toggleTodoStatus(store, todo) {
    var postData = { id: todo.id };
...
var mutations = {
    ...
    TOGGLE_STATUS_TODO: function TOGGLE_STATUS_TODO(state, todo) {
        _underscore2.default.each(state.todos, function (value, index) {
            if (todo.id === value.id) {
...
var _Dashboard = require('./pages/Dashboard.vue');
...
var vueInstance = _vue2.default.extend({
...
exports.default = {
    components: {
        TodoItems: _TodoItems2.default
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"row\">\n    <div class=\"col-md-6\">\n        <div class=\"panel panel-default\">\n            <div class=\"panel-heading\">My Todos <i class=\"fa fa-list pull-right\"></i></div>\n            <div class=\"panel-body\">\n                <todo-items></todo-items>\n            </div>\n        </div>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-2451563e", module.exports)
  } else {
    hotAPI.update("_v-2451563e", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
